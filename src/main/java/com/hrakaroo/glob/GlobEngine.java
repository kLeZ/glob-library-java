...
class GlobEngine implements MatchingEngine {
	 ...
	 */
	protected GlobEngine(final char[] lowerCase, final char[] upperCase, final boolean[] wildcard, final boolean[] matchOne, final int length) {
	...
	public boolean matches(final String string) {
		...
		while (true) {
			...
			if (charsIndex == string.length() || patternIndex == length || (!matchOne[patternIndex] && string.charAt(charsIndex) != lowerCase[patternIndex] && string.charAt(charsIndex) != upperCase[patternIndex])) {
