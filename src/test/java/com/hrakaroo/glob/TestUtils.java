...
public class TestUtils {
	 ...
	 */
	protected void compile(Class<? extends MatchingEngine> clazz, String pattern, String upperCase, String lowerCase, int globMask, int blankMask) {
		...
		if (matchingEngine instanceof GlobEngine globEngine) {
		...
		} else if (matchingEngine instanceof ContainsEngine containsEngine) {
		...
		} else if (matchingEngine instanceof EndsWithEngine endsWithEngine) {
		...
		} else if (matchingEngine instanceof StartsWithEngine startsWithEngine) {
		...
		} else if (matchingEngine instanceof EqualToEngine equalToEngine) {
			// Verify zero size
