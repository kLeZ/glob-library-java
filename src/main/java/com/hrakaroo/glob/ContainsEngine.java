...
class ContainsEngine implements MatchingEngine {
	 ...
	 */
	protected ContainsEngine(final char[] lowerCase, final char[] upperCase, final boolean[] matchOne, final int length) {
	...
	public boolean matches(final String string) {
		...
		while (true) {
			...
			if (charsIndex != string.length() && (matchOne[patternIndex] || string.charAt(charsIndex) == lowerCase[patternIndex] || string.charAt(charsIndex) == upperCase[patternIndex])) {
