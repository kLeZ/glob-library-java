...
public class GlobPattern {
	 ...
	 *                     To turn this feature off pass in the null '\0' character.
	 * @param flags        Match flags, a bit mask that may include {@link #CASE_INSENSITIVE} and
	 *                     {@link #HANDLE_ESCAPES}
	 ...
	 */
	public static MatchingEngine compile(final String globPattern, final char wildcardChar, final char matchOneChar, final int flags) {
